                        ...
                        <div className="col-12 col-md-6 col-lg-4 seeker_list my-2 mx-2" key={index}>
                            <div className="card p-2 h-100">
                                <div className="text-center ">
                                    <img className="seeker_img img-fluid border border-dark rounded-circle " src={`http://localhost:9000/upload/${item?.logo}`} alt={item.name} style={{ maxWidth: '100px', height: '100px' }} />
                                </div>
